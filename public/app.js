...
},{"./update-events.js":366,"bel":27,"morphdom":352}],366:[function(require,module,exports){
module.exports = [
...
var el = yoyo(_templateObject, translate.message('language'), lang.bind(null, 'es'), translate.message('spanish'), lang.bind(null, 'en-US'), translate.message('english'));
...
},{"../translate":382,"yo-yo":365}],368:[function(require,module,exports){
'use strict';

var _templateObject = _taggedTemplateLiteral(['\n  <nav class="header">\n    <div class="nav-wrapper">\n      <div class="container">\n        <div class="row">\n          <div class="col s12 m6 offset-m1">\n            <a href="/" class="brand-logo platzigram">Platzigram</a>\n          </div>\n          <div class="col s2 m6 offset-s10 offset-m10">\n            <a href="#" class="btn btn-large btn-flat dropdown-button" data-activates="drop-user">\n              <i class="fa fa-user" aria-hidden="true"></i>\n            </a>\n            <ul id="drop-user" class="dropwdown-content">\n              <li>\n                <a href="#">', '</a>\n              </li>\n            </ul>\n          </div>\n        </div>\n      </div>\n    </div>\n  </nav>\n  '], ['\n  <nav class="header">\n    <div class="nav-wrapper">\n      <div class="container">\n        <div class="row">\n          <div class="col s12 m6 offset-m1">\n            <a href="/" class="brand-logo platzigram">Platzigram</a>\n          </div>\n          <div class="col s2 m6 offset-s10 offset-m10">\n            <a href="#" class="btn btn-large btn-flat dropdown-button" data-activates="drop-user">\n              <i class="fa fa-user" aria-hidden="true"></i>\n            </a>\n            <ul id="drop-user" class="dropwdown-content">\n              <li>\n                <a href="#">', '</a>\n              </li>\n            </ul>\n          </div>\n        </div>\n      </div>\n    </div>\n  </nav>\n  ']);
...
var el = yoyo(_templateObject, translate.message('logout'));
...
},{"../translate":382,"empty-element":324,"yo-yo":365}],369:[function(require,module,exports){
'use strict';

var _templateObject = _taggedTemplateLiteral(['\n    <div class="row">\n      <div class="col s5 m5">\n        <a href="/users/', '" class="card-title activator">\n          <img src="', '" class="avatar-users" />\n          <p class="header-username">', '</p>\n        </a>\n      </div>\n      <div class="col s5 m5 center-align">\n        <p class="paragraphs">', '</p>\n      </div>\n      <div class="row pic-container">\n        <div class="col s3 m3 offset-s2 offset-m2 container-photos">\n            <img src="../', '" class="avatar-users" />\n            <div class="avatar-users hide-info"><i class="fa fa-heart"></i>', '</div>\n        </div>\n        <div class="col s3 m3 container-photos">\n            <img src="../', '" class="avatar-users" />\n            <div class="avatar-users hide-info"><i class="fa fa-heart"></i>', '</div>\n        </div>\n        <div class="col s3 m3 container-photos">\n            <img src="../', '" class="avatar-users" />\n            <div class="avatar-users hide-info"><i class="fa fa-heart"></i>', '</div>\n        </div>\n      </div>\n      <div class="row pic-container">\n        <div class="col s3 m3 offset-s2 offset-m2 container-photos">\n            <img src="../', '" class="avatar-users" />\n            <div class="avatar-users hide-info"><i class="fa fa-heart"></i>', '</div>\n        </div>\n        <div class="col s3 m3 container-photos">\n            <img src="../', '" class="avatar-users" />\n            <div class="avatar-users hide-info"><i class="fa fa-heart"></i>', '</div>\n        </div>\n        <div class="col s3 m3 container-photos">\n            <img src="../', '" class="avatar-users" />\n            <div class="avatar-users hide-info"><i class="fa fa-heart"></i>', '</div>\n        </div>\n      </div>\n    </div>'], ['\n    <div class="row">\n      <div class="col s5 m5">\n        <a href="/users/', '" class="card-title activator">\n          <img src="', '" class="avatar-users" />\n          <p class="header-username">', '</p>\n        </a>\n      </div>\n      <div class="col s5 m5 center-align">\n        <p class="paragraphs">', '</p>\n      </div>\n      <div class="row pic-container">\n        <div class="col s3 m3 offset-s2 offset-m2 container-photos">\n            <img src="../', '" class="avatar-users" />\n            <div class="avatar-users hide-info"><i class="fa fa-heart"></i>', '</div>\n        </div>\n        <div class="col s3 m3 container-photos">\n            <img src="../', '" class="avatar-users" />\n            <div class="avatar-users hide-info"><i class="fa fa-heart"></i>', '</div>\n        </div>\n        <div class="col s3 m3 container-photos">\n            <img src="../', '" class="avatar-users" />\n            <div class="avatar-users hide-info"><i class="fa fa-heart"></i>', '</div>\n        </div>\n      </div>\n      <div class="row pic-container">\n        <div class="col s3 m3 offset-s2 offset-m2 container-photos">\n            <img src="../', '" class="avatar-users" />\n            <div class="avatar-users hide-info"><i class="fa fa-heart"></i>', '</div>\n        </div>\n        <div class="col s3 m3 container-photos">\n            <img src="../', '" class="avatar-users" />\n            <div class="avatar-users hide-info"><i class="fa fa-heart"></i>', '</div>\n        </div>\n        <div class="col s3 m3 container-photos">\n            <img src="../', '" class="avatar-users" />\n            <div class="avatar-users hide-info"><i class="fa fa-heart"></i>', '</div>\n        </div>\n      </div>\n    </div>']);
...
module.exports = function headerUsers(pic) {
  ...
  function renderUsers(picture) {
    console.log(picture);
    return yoyo(_templateObject, picture.user.username, picture.user.avatar, picture.user.username, picture.user.about, picture.url.img0, picture.descriptions.like0, picture.url.img1, picture.descriptions.like1, picture.url.img2, picture.descriptions.like2, picture.url.img3, picture.descriptions.like3, picture.url.img4, picture.descriptions.like4, picture.url.img5, picture.descriptions.like5);
  }
...
},{"yo-yo":365}],370:[function(require,module,exports){
'use strict';
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          return _context.abrupt('return', console.log('Error: ' + _context.t0));
...
module.exports = function template(pictures) {
  var el = yoyo(_templateObject, onSubmit, translate.message('upload-picture'), onChange, translate.message('upload'), cancel, pictures.map(function (pic) {
    return picture(pic);
  }));
...
},{"../layout":374,"../picture-card":375,"../translate":382,"superagent":358,"yo-yo":365}],372:[function(require,module,exports){
'use strict';
...
},{"./footer":367,"./homepage":370,"./signin":376,"./signup":378,"./users":383,"babel-polyfill":26,"page":354}],373:[function(require,module,exports){
'use strict';
...
},{"yo-yo":365}],374:[function(require,module,exports){
'use strict';
...
module.exports = function layout(content) {
  return yoyo(_templateObject, content);
};

},{"../translate":382,"yo-yo":365}],375:[function(require,module,exports){
'use strict';
...
module.exports = function pictureCard(pic) {
  ...
  function render(picture) {
    return yoyo(_templateObject, picture.liked ? 'liked' : '', picture.url, picture.user.username, picture.user.avatar, picture.user.username, translate.date.format(picture.createdAt), like.bind(null, true), like.bind(null, false), translate.message('likes', { likes: picture.likes }));
  }
...
},{"../translate":382,"yo-yo":365}],376:[function(require,module,exports){
'use strict';
...
var signinForm = yoyo(_templateObject, translate.message('signup.facebook'), translate.message('signup.text'), translate.message('username'), translate.message('password'), translate.message('signup.text'), translate.message('signin.not-have-account'), translate.message('signup.call-to-action'));

module.exports = landing(signinForm);

},{"../landing":373,"../translate":382,"yo-yo":365}],378:[function(require,module,exports){
'use strict';
...
},{"./template":379,"empty-element":324,"page":354}],379:[function(require,module,exports){
'use strict';
...
},{"./en-US":380,"./es":381,"intl":346,"intl-messageformat":331,"intl-relativeformat":340,"intl-relativeformat/dist/locale-data/en.js":338,"intl-relativeformat/dist/locale-data/es.js":339,"intl/locale-data/jsonp/en-US.js":348,"intl/locale-data/jsonp/es.js":349}],383:[function(require,module,exports){
'use strict';
...
function loadUserPictures(ctx, next) {
  axios.get('/user/pics').then(function (res) {
    ctx.pictures = res.data;
    next();
  }).catch(function (err) {
    console.log(err);
...
},{"../header":368,"./template":384,"axios":1,"empty-element":324,"page":354}],384:[function(require,module,exports){
'use strict';
...
module.exports = function userLayout(pictures) {
  var userLayout = yoyo(_templateObject, pictures.map(function (pic) {
    return headerUsers(pic);
  }));
  return layout(userLayout);
};

},{"../headerusers":369,"../layout":374,"yo-yo":365}]},{},[372]);
