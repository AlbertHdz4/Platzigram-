...
},{"./homepage":18,"./signin":24,"./signup":26,"page":13}],21:[function(require,module,exports){
'use strict';
...
module.exports = function pictureCard(pic) {
  ...
  function render(picture) {
    return yoyo(_templateObject, picture.liked ? 'liked' : '', picture.url, picture.user.username, picture.user.avatar, picture.user.username, moment(picture.createdAt).fromNow(), like.bind(null, true), like.bind(null, false), picture.likes);
  }
...
},{"moment":10,"moment/locale/es":9,"yo-yo":16}],24:[function(require,module,exports){
'use strict';
